...
?>
<h4>Bonjour admin!</h4>
<table class="table table-bordered" style="width: 56%;margin-bottom: 1rem;color: #212529;margin-left: 18rem;text-align: center;">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <path fill-rule="evenodd" d="M8 2.5A5.5 5.5 0 1013.5 8a.5.5 0 011 0 6.5 6.5 0 11-3.25-5.63.5.5 0 11-.5.865A5.472 5.472 0 008 2.5z" clip-rule="evenodd"/>
      ...
      <td colspan="2">Liste des produits dont le stock est trop bas</td>
  ...
  <path fill-rule="evenodd" d="M8 2.5A5.5 5.5 0 1013.5 8a.5.5 0 011 0 6.5 6.5 0 11-3.25-5.63.5.5 0 11-.5.865A5.472 5.472 0 008 2.5z" clip-rule="evenodd"/>
      ...
      <td colspan="2">Entrer une nouvelle commande</td>
     
    </tr> 
  </tbody>
</table>
<button type="button" class="btn btn-outline-primary" style="margin-left: 35rem;padding: 0.375rem 2.75rem;">valider</button>
